...
if echo $flag; then
    ...
    while IFS=' ' read -r domains; do
        if echo "$domains" | grep -q "web" ;then 
            sudo mkdir -p /home/clubadmin/mentees/$username/web/Task1
            sudo mkdir -p /home/clubadmin/mentees/$username/web/Task2
            sudo mkdir -p /home/clubadmin/mentees/$username/web/Task3
        ...
        echo " Web: 
                Task 1: "$wt1"
                Task 2: "$wt2"
                Task 3: "$wt3" " | sudo tee -a /home/clubadmin/mentees/$username/task_submitted.txt

        fi


        if echo "$domains" | grep -q "app" ;then 
            sudo mkdir -p /home/clubadmin/mentees/$username/app/Task1
            sudo mkdir -p /home/clubadmin/mentees/$username/app/Task2
            sudo mkdir -p /home/clubadmin/mentees/$username/app/Task3
        ...
        echo " App: 
                Task 1: "$at1"
                Task 2: "$at2"
                Task 3: "$at3" " | sudo tee -a /home/clubadmin/mentees/$username/task_submitted.txt

        fi


        if echo "$domains" | grep -q "sysad" ;then
            sudo mkdir -p /home/clubadmin/mentees/$username/sysad/Task1
            sudo mkdir -p /home/clubadmin/mentees/$username/sysad/Task2
            sudo mkdir -p /home/clubadmin/mentees/$username/sysad/Task3
        ...
        echo " Sysad: 
                Task 1: "$st1"
                Task 2: "$st2"
                Task 3: "$st3" " | sudo tee -a /home/clubadmin/mentees/$username/task_submitted.txt
    ...
    while IFS=' ' read -r userid; do
        if [[ -d "/home/clubadmin/mentees/$userid/$pref/Task1" &&  -d "/home/clubadmin/mentees/$userid/$pref/Task2" && -d "/home/clubadmin/mentees/$userid/$pref/Task3" ]]; then
            ...
            if [ "$(find /home/clubadmin/mentees/$userid/$pref/Task1 | wc -l)" -ne 0 ]; then
                ...
                echo "$pref Task1 completed" | sudo tee -a /home/clubadmin/mentees/$userid/task_completed.txt
            fi
            ...
            if [ "$(find /home/clubadmin/mentees/$userid/$pref/Task2 | wc -l)" -ne 0 ]; then
                ...
                echo "$pref Task2 completed" | sudo tee -a /home/clubadmin/mentees/$userid/task_completed.txt
            fi
            ...
            if [ "$(find /home/clubadmin/mentees/$userid/$pref/Task3 | wc -l)" -ne 0 ]; then
                ...
                echo "$pref Task3 completed" | sudo tee -a /home/clubadmin/mentees/$userid/task_completed.txt
            fi
